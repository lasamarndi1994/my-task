        ...
        <div class="w-100 pa-8 pa-md-12" style="max-width: 480px">
          ...
          <v-form @submit.prevent="handleLogin" v-model="isValid">
            <v-text-field v-model="email" label="Email Address" prepend-inner-icon="mdi-email-outline"
              variant="outlined" color="primary" :rules="[rules.required, rules.email]" class="mb-2 custom-input"
              rounded="lg" density="compact"></v-text-field>
            ...
            <v-text-field v-model="password" label="Password" prepend-inner-icon="mdi-lock-outline"
              ...
              variant="outlined" color="primary" :rules="[rules.required]" class="mb-4 custom-input" rounded="lg"
          ...
          <div class="d-flex gap-4 justify-center">
            <v-btn variant="outlined" class="flex-grow-1 text-none" rounded="lg" height="44">
              <v-icon icon="mdi-google" color="#4285F4" class="mr-2"></v-icon>
              Google
            </v-btn>
            <v-btn variant="outlined" class="flex-grow-1 text-none ml-2" rounded="lg" height="44">
