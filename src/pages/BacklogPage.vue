<template>
  <v-container fluid class="h-100 pa-6">
    <h1 class="text-h5 font-weight-bold mb-6 text-high-emphasis">Backlog</h1>

    <!-- Sprint Section -->
    <v-card class="mb-6 rounded-lg" border flat>
      <v-card-title class="d-flex align-center py-3 bg-surface-variant">
        <span class="text-subtitle-2 font-weight-bold text-high-emphasis">Sprint 1</span>
        ...
        <v-spacer></v-spacer>
        <v-btn size="small" variant="flat" color="surface-variant" class="mr-2 border" border>Complete sprint</v-btn>
        ...
        <v-list-item v-for="issue in sprintIssues" :key="issue.id" class="border-b" min-height="48">
          ...
          <template v-slot:append>
            <div class="d-flex align-center">
              ...
              <v-chip size="small" color="surface-variant" variant="flat">3</v-chip>
            </div>
          </template>
        </v-list-item>
      </v-list>
    ...
    <v-card class="rounded-lg" border flat>
      <v-card-title class="d-flex align-center py-3 bg-surface-variant">
        <span class="text-subtitle-2 font-weight-bold text-high-emphasis">Backlog</span>
        ...
        <v-list-item v-for="issue in backlogIssues" :key="issue.id" class="border-b" min-height="48">
          ...
          <template v-slot:append>
            <div class="d-flex align-center">
              ...
              <v-chip size="small" color="surface-variant" variant="flat">2</v-chip>
            </div>
          </template>
        </v-list-item>
      </v-list>
